...
export abstract class SucursalRepository {
  ...
  abstract update(id: string, name: string, direccion: string, latitude: number, longitude: number, telefono: string, correo: string, timezone?: string): Promise<Sucursal>;
