...
export class UpdateVisitUseCase {
  ...
  execute(updateVisitDto: UpdateVisitDto, tenantId: string, sucursalId: string, id: string, userId: string): Promise<VisitEntity> {
    ...
    return this.visitRepo.update(tenantId, sucursalId, userId, id, updateVisitDto);
  }
}